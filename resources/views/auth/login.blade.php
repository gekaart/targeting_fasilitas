...
<head>
    ...
    <title>Sign In | Silat</title>

    <link href="bs/css/app.css" rel="stylesheet">
                            ...
                            <div class="card-body">
                                <div class="m-sm-4">
                                    <div class="text-center">
                                        {{-- <img src="bs/img/avatars/avatar.jpg" alt="Charles Hall" class="img-fluid rounded-circle" width="132" height="132" /> --}}
                                        {{-- <h2>SILAT</h2> --}}
                                        <h3> <b> SISTEM INFORMASI FASILITAS DAN TARGETING </b></h3><br>
                                    </div>
                                    @if ($errors->any())
